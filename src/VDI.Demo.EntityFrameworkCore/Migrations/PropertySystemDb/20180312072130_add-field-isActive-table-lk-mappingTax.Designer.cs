...
namespace VDI.Demo.Migrations.PropertySystemDb
{
    ...
    [Migration("20180312072130_add-field-isActive-table-lk-mappingTax")]
    partial class addfieldisActivetablelkmappingTax
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.DocNo_Counter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.LK_MappingTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_BookingDetailAddDiscHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TR_BookingDetailAddDiscHistory");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_BookingDocument", b =>
                {
                    ...
                    b.Property<string>("tandaTerimaBy")
                        .HasMaxLength(100);

                    b.Property<DateTime?>("tandaTerimaDate");

                    b.Property<string>("tandaTerimaFile")
                        .HasMaxLength(150);

                    b.Property<string>("tandaTerimaNo")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_BookingHeaderHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TR_BookingHeaderHistory");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_CommAddDiscHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TR_CommAddDiscHistory");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_MKTAddDiscHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TR_MKTAddDiscHistory");
                });

            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_PaymentBulk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("bulkPaymentKey")
                        .IsRequired()
                        .HasMaxLength(150);
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.OnlineBooking.ProjectInfo.MS_PromoOnlineBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("promoAlt")
                        .IsRequired()
                        .HasMaxLength(500);

                    b.Property<string>("promoDataType")
                        .IsRequired()
                        .HasMaxLength(10);

                    b.Property<string>("promoFile")
                        .IsRequired()
                        .HasMaxLength(200);
                    ...
                    b.ToTable("MS_PromoOnlineBooking");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.OnlineBooking.PropertySystem.MS_BankOLBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.Pricing.LK_FormulaDP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("formulaDPDesc")
                        .IsRequired()
                        .HasMaxLength(100);

                    b.Property<string>("formulaDPType")
                        .IsRequired()
                        .HasMaxLength(5);

                    b.HasKey("Id");

                    b.ToTable("LK_FormulaDP");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.LippoMaster.TR_BookingDetailDP", b =>
                {
                    ...
                    b.HasOne("VDI.Demo.PropertySystemDB.Pricing.LK_FormulaDP", "LK_FormulaDP")
                        .WithMany("TR_BookingDetailDP")
                        .HasForeignKey("formulaDPID");
                });
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.OnlineBooking.ProjectInfo.MS_PromoOnlineBooking", b =>
                {
                    b.HasOne("VDI.Demo.PropertySystemDB.MasterPlan.Project.MS_Project", "MS_Project")
                        .WithMany("MS_PromoOnlineBooking")
                        .HasForeignKey("projectID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
