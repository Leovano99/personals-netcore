...
namespace VDI.Demo.Migrations
{
    ...
    [Migration("20180201025737_AddTable_MappingUser")]
    partial class AddTable_MappingUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VDI.Demo.Authorization.Applications.MS_Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("MS_Application");
                });

            modelBuilder.Entity("VDI.Demo.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.OnlineBooking.DemoDB.MP_UserPersonals", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("MP_UserPersonals");
                });

            modelBuilder.Entity("VDI.Demo.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VDI.Demo.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("VDI.Demo.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("VDI.Demo.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("VDI.Demo.Authorization.Roles.Role", b =>
                {
                    b.HasOne("VDI.Demo.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("VDI.Demo.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("VDI.Demo.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("VDI.Demo.PropertySystemDB.OnlineBooking.DemoDB.MP_UserPersonals", b =>
                {
                    b.HasOne("VDI.Demo.Authorization.Users.User", "User")
                        .WithMany("MP_UserPersonals")
                        .HasForeignKey("userID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
