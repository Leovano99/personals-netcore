...
using VDI.Demo.Authentication.TwoFactor.Google;
using VDI.Demo.Authorization;
using VDI.Demo.Authorization.Users;
using VDI.Demo.MultiTenancy;
using VDI.Demo.Web.Authentication.JwtBearer;
using VDI.Demo.Web.Authentication.TwoFactor;
using VDI.Demo.Web.Models.TokenAuth;
...
namespace VDI.Demo.Web.Controllers
{
    ...
    {
        private const string UserIdentifierClaimType = "http://yourWebsite.com/claims/useridentifier";
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            //_sessionappservice.SetSessionData("UserTenant", "1,2,3"); //jika ingin memakai session, lakukan hal seperti ini dg value dan key yang diinginkan
        ...
        //private async Task<AbpLoginResult<Tenant, User>> GetLoginResultAsyncMobile(string usernameOrEmailAddress, string password, string tenancyName)
        //{
        //    var loginResult = await _logInManager.LoginAsync(usernameOrEmailAddress, password, tenancyName);
